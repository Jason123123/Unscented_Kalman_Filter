...
void UKF::Prediction(double delta_t) {
  ...
  */
  ...
  // make prediction based on augmented state
  ...
  /* calculate gaussian distribution from sigma points */
...
void UKF::UpdateLidar(MeasurementPackage meas_package) {
  ...
  */
  ...
  // because the transformation is linear, we do not need to recalculate the gaussian distribution
  for (int i = 0; i < 2 * n_aug_ + 1; i++) {
